          ...
          <div>
              ...
              <>
                ...
                <div className="px-4 py-3 space-y-3">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-muted-foreground block">Anchor Point</label>
                  ...
                  <PropertyInput label="Constraints" value="Aspect Ratio" placeholder="Constraints" />
            ...
            {expandedSections.has('appearance') && (
              <>
                ...
                <div className="px-4 py-3 space-y-3">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-muted-foreground block">Fill</label>
                  ...
                  <PropertyInput label="Corner Radius" value="8" placeholder="Radius" />
        ...
        {activeTab === 'prototype' && (
          <div className="p-4">
            <p className="text-xs text-muted-foreground">
              No prototype interactions selected. Select an element to add interactions.
            </p>
          </div>
        )}
